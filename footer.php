	...
	<?if(isset($res['url'])){?>
		...
		<section id="partage" class="mw960p flex wrap jcc center tc ptl pbl">
			...
			<div class="plm">
				...
				<a href="https://www.facebook.com/sharer/sharer.php?u=<?=$url_encode?>" target="_blank"><i class="fa fa-fw fa-facebook big mls mrm" aria-hidden="true"></i>Facebook</a>
				
				<a href="mailto:?subject=<?=$titre_encode?>&body=<?=$url_encode?>" target="_blank"><i class="fa fa-fw fa-mail big mls mrm" aria-hidden="true"></i>Mail</a>
